...
export default class Lightbox extends Component {
	...
	render() {
		const { medium, large, alt, onClose, hideDownload, hideZoom, showRotate, imageBackgroundColor = 'black' } = this.props;
		const { move, zoomed, rotationDeg } = this.state;

		return (
			<div>
				<StyleInjector name='__react_modal_image__lightbox' css={lightboxStyles({ imageBackgroundColor })} />
